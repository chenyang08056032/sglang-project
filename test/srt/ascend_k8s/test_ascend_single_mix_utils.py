...
QWQ_32B_MODEL_PATH = "/data/ascend-ci-share-pkking-sglang/modelscope/hub/models/vllm-ascend/QWQ-32B-W8A8"
QWQ_32B_OTHER_ARGS = [
    "--trust-remote-code",
    "--nnodes",
    "1",
...
Qwen3_Next_80B_A3B_MODEL_PATH = "/data/ascend-ci-share-pkking-sglang/modelscope/hub/models/Qwen/Qwen3-Next-80B-A3B-Instruct"
